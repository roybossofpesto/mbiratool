...
const nema_full = (aa, bb, cc, index) => { // Nemamoussassa left hand & right hand
    ...
    let foo = [
        ...
        ///////
        create_note(aa, 0, 5),   create_note(aa, 0, 5),
        create_note(aa, 0, 4),   create_note(aa, 0, 5),
        create_note(bb, 0, 5),   create_note(bb, 0, 5),
        create_note(bb, 0, 4),   create_note(bb, 0, 5),
        create_note(cc+1, 4, 5), create_note(cc+1, 0, 5),
        create_note(cc+1, 0, 4), create_note(cc+1, 0, 5),
        ///////
        create_note(aa, 0, 5),   create_note(aa, 0, 5),
        create_note(aa, 0, 4),   create_note(aa, 0, 5),
        create_note(bb+1, 0, 5), create_note(bb+1, 0, 5),
        create_note(bb+1, 0, 4), create_note(bb+1, 0, 5),
        create_note(cc+1, 4, 5), create_note(cc+1, 0, 5),
        create_note(cc+1, 0, 4), create_note(cc+1, 0, 5),
        ///////
        create_note(aa+1, 0, 5), create_note(aa+1, 0, 5),
        create_note(aa+1, 0, 4), create_note(aa+1, 0, 5),
        create_note(bb+1, 0, 5), create_note(bb+1, 0, 5),
        create_note(bb+1, 0, 4), create_note(bb+1, 0, 5),
        create_note(cc+1, 4, 5), create_note(cc+1, 0, 5),
        create_note(cc+1, 0, 4), create_note(cc+1, 0, 5),
